...
function startClassification() {
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/Z6PqoeBzV/model.json", modelReady);
}
...
function gotResults(error, results) {
    if (error) {
        ...
        else if (results[0].label == "ommmmm") {
            img.src = "aliens-01.png"
            img1.src = "aliens-02.png"
            img2.src = "aliens-03.gif"
            img3.src = "aliens-04.png"
        }
        else (results[0].label == "Whack head")
        {
            img.src = "aliens-01.png"
            img1.src = "aliens-02.png"
            img2.src = "aliens-03.png"
